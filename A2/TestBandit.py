...
empiricalMeans,_,_ = banditProblem.epsilonGreedyBandit(nIterations=100000)
print("\nepsilonGreedyBandit results")
print(empiricalMeans)

# Test Thompson sampling strategy
empiricalMeans,_,_ = banditProblem.thompsonSamplingBandit(prior=np.ones([mdp.nActions,2]),nIterations=100000)
print("\nthompsonSamplingBandit results")
print(empiricalMeans)

# Test UCB strategy
empiricalMeans,_,_ = banditProblem.UCBbandit(nIterations=100000)
print("\nUCBbandit results")
print(empiricalMeans)
